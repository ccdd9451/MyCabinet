...
private:
		...
		void generateNextSubSpaceWithoutObstacles();
		...
		void clearScenario ();
		void clearScenarioKeepObstacles();
...
private:
	...
	*/
	...
	std::vector<double> _circleParams;
	std::vector<double> _doorHorizontalParams;
	std::vector<double> _doorVerticalParams;
	std::vector<double> _finHorizontalParams;
	std::vector<double> _rotBarParams;
	std::vector<double> _finVerticalParams;
	std::vector<double> _miscAParams;
	std::vector<double> _miscBParams;
	std::vector<double> _miscCParams;
	std::vector<double> _rotateBoxParams;
	std::vector<double> _boxParams;
	std::vector<double> _freeBarParams;
	double wallDoorRadius;
	std::vector<double> _subspaceWallParams;

	bool _prettyLog;

	float _parameters[100];
	unsigned int _indexParam;

	void loadSelfDefinedObstacles();
	...
	bool _readParam;
	bool _sfUse;
	unsigned int _numReSim;
};

inline bool str2bool(std::string s)
{
    return s == "true";
}
